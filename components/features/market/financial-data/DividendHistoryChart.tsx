...
import type { DividendHistoryData } from "./types";
      ...
      <CardContent>
        {data.length === 0 ? (
          ...
          <div className="h-48 w-full bg-muted/30 rounded-md flex items-center justify-center relative">
            <div className="absolute top-2 right-2 text-xs text-muted-foreground">6.3%</div>
            <div className="absolute bottom-2 right-2 text-xs text-muted-foreground">1.5%</div>
            ...
            <div className="w-full h-full flex items-end justify-center p-4">
              <div className="flex items-end gap-4 w-full h-full">
                <div className="flex-1 flex flex-col items-center gap-1">
                  <div className="w-full h-1/3 bg-green-500 rounded-t" />
                ...
                <div className="flex-1 flex flex-col items-center gap-1">
                  <div className="w-full h-2/3 bg-green-500 rounded-t" />
                  <div className="w-full h-1 border-t-2 border-orange-500" />
                </div>
              </div>
            </div>
            <div className="absolute bottom-2 left-1/2 -translate-x-1/2 flex gap-4">
              <div className="flex items-center gap-1">
                ...
                <span className="text-xs">Dividends per share (FY)</span>
              </div>
              <div className="flex items-center gap-1">
