...
import type { ESGChartDataPoint } from "./types";

interface ESGScoreOverviewProps {
  data?: ESGChartDataPoint[];
  isLoading?: boolean;
}

const timeRanges = ["1 day", "5 days", "1 month", "6 months", "1 year"];

export function ESGScoreOverview({ data = [], isLoading = false }: ESGScoreOverviewProps) {
